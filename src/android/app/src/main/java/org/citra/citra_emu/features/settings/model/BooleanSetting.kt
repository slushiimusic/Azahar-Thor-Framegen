...
enum class BooleanSetting(
    ...
    FRAME_GENERATION(SettingKeys.frame_generation(), Settings.SECTION_RENDERER, false),
    FRAME_GEN_QUALITY(SettingKeys.frame_gen_quality(), Settings.SECTION_RENDERER, false),
